...
export const assets = {
    ...
    {
        id:3,
        title:"Programming vs Coding: Why They're Not the Same",
        description:"People often use the words 'programming' and 'coding' interchangeably, but are they really the same thing? In this article...",
        image:blog_pic_3,
        date:Date.now(),
        category:"Technology",
    ...
    {
        id:4,
        title:"Is SaaS Really Dead or Just Evolving?",
        description:"The Rise of AI agents and the Return of Middleware Questions",
        image:blog_pic_4,
        date:Date.now(),
        category:"Technology",
    ...
    {
        id:7,
        title:"Meta Frontend Developer Interview Questions with Expert Answers",
        description:"Ace your Meta frontend developer interview! Explore top questions with expert answers to bosst your prep and land your...",
        image:blog_pic_7,
        date:Date.now(),
        category:"Technology",
    ...
    {
        id:12,
        title:"Why Santa Claus is the Perfect Product Manager",
        description:"If Santa Claus were looking for a job in tech, it is hard to deny he'd slip effortlessly into the role of a Product Manager, Forget the...",
        image:blog_pic_12,
        date:Date.now(),
        category:"Technology",
