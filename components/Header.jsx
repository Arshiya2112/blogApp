...
<div className='text-center my-8'>
    ...
    <p className='mt-10 max-w-[740px] m-auto text-xs sm:text-base'>Dive into the world of latest technology trends, best practices and all things tech!</p>
    <form action="" className='flex justify-between max-w-[500px] scale-75 sm:scale-100 mx-auto mt-10 border border-black shadow-[-7px_7px_0px_#000000]'>
        ...
        onSubmit={onSubmitHandler}>Subscribe</button>
    </form>
